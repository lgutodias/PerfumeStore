...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('PerfumeStore.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('PerfumeStore.xsl', 'utf8'); //We are reading in the XSL file

    var xml_parse = xmlParse(xml); //Parsing our XML file
    var xsl_parse = xmlParse(xsl); //Parsing our XSL file

    var result = xsltProcess(xml_parse, xsl_parse); //This does our XSL Transformation
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        xmlFileToJs('PerfumeStore.xml', function (err, result) {
            if (err) throw (err);
            ...
            jsToXmlFile('PerfumeStore.xml', result, function(err){
...
router.post('/post/delete', function (req, res) {
    ...
    function deleteJSON(obj) {
        ...
        xmlFileToJs('PerfumeStore.xml', function (err, result) {
            ...
            delete result.perfume_catalog.section[obj.section].perfume[obj.perfume];
